...
// LocateKey
IntegerVector LocateKey(IntegerVector& key, int keysize, IntegerVector& randomint, ListOf<List>& hashtable);
...
// LocateKeys
IntegerMatrix LocateKeys(ListOf<IntegerVector>& keys, int keysize, IntegerVector& randomint, ListOf<List>& hashtable);
...
// GetValueByKey
List GetValueByKey(IntegerVector& key, int keysize, IntegerVector& randomint, ListOf<List>& hashtable);
...
// GetValueByKeys
List GetValueByKeys(ListOf<IntegerVector>& keys, int keysize, IntegerVector& randomint, ListOf<List>& hashtable);
...
// FindKey
bool FindKey(IntegerVector& key, int keysize, IntegerVector& randomint, ListOf<List>& hashtable);
...
// FindKeys
LogicalVector FindKeys(ListOf<IntegerVector>& keys, int keysize, IntegerVector& randomint, ListOf<List>& hashtable);
